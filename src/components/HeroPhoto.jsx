...
/**
 * Large portrait card for the hero — replaces the code panel visual.
 * The image lives at public/headshot.png (400x400 or larger, square).
 * Keeps the same visual footprint and glow treatment the code panel had
 * so the hero composition still balances against the headline column.
 */
export function HeroPhoto() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-md sm:max-w-lg">
      ...
      <div
        aria-hidden="true"
        className="absolute -inset-8 -z-10 rounded-[2rem] bg-gradient-to-br from-accent-500/12 via-transparent to-transparent blur-2xl"
      />
      ...
      >
        ...
        {/* Subtle bottom gradient for readability of the caption */}
        <div
          aria-hidden="true"
